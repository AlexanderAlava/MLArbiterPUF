...
#test_sampled_data = sampled_data.sample(frac=0.5)
#test_train_data = test_sampled_data.drop(sampled_data.columns[[64]], axis=1).values
#test_train_responses = test_sampled_data[sampled_data.columns[[64]]].values
...
model = keras.Sequential([
    keras.layers.Dense(32, activation=tf.nn.relu, input_shape=(64,)),
